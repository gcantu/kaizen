# Generated by Django 2.0.6 on 2018-07-25 04:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('texture', models.CharField(blank=True, choices=[('Smooth', 'Eco Wood (Smooth)'), ('Textured', 'Facade (Textured)')], max_length=10, null=True)),
        ...
        migrations.AddField(
            model_name='line_item',
            name='product_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='proposal.product_type'),
        ),
        migrations.AddField(
            model_name='line_item',
            name='proposal',
        ...
        migrations.AddField(
            model_name='line_item',
            name='style',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='proposal.product_style'),
        ),
    ]
